...
class OrdersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($orders)
                ...
                ->addColumn('action', function ($order) use ($id, $queryString)   {
                    $label='';
                    ...
                    $action .='<a href="' .url('admin/update-status-order/'.Hashids::encode($order->id)) .''. $queryString .'" class="text-success btn-order" data-toggle="tooltip" title="Update Status and Delivery Status"><i class="fa fa-edit fa-lg"></i></a>';
    ...
    public function show($id)
    {
        ...
        //     $cartContents = $order->purchasedItems;
        // }
