                     ...
                     <div class="col-12 col-md-6 col-lg-6 col-xl-5">
                        <div class="header-top-left">
                           <ul class="header-top-list">
                              <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#137a7d757c53766b727e637f763d707c7e"><i class="far fa-envelopes"></i>
                                 <span class="__cf_email__" data-cfemail="ec85828a83ac89948d819c8089c28f8381">[email&#160;protected]</span></a>
                              </li>
                     ...
                     <div class="offcanvas-body">
                                    ...
                                    <div class="container-fluid px-lg-0">
                                       <div class="row">
                                          <div class="col-12 col-lg-2">
                                             <h5 class="mega-menu-title">Furniture</h5>
                                             <ul class="mega-menu-item">
                                                <li><a class="dropdown-item" href="shop-grid.html">Bedroom</a></li>
                                                <li><a class="dropdown-item" href="shop-grid.html">Living
                                                   Room</a>
                                                </li>
                                                <li><a class="dropdown-item" href="shop-grid.html">Bathroom</a></li>
                                                <li><a class="dropdown-item" href="shop-grid.html">Decoration</a></li>
                                                <li><a class="dropdown-item" href="shop-grid.html">Office</a></li>
                                                <li><a class="dropdown-item" href="shop-grid.html">Kitchen</a></li>
                                             </ul>
                                          </div>
                                          <div class="col-12 col-lg-2">
                                             <h5 class="mega-menu-title">Furniture</h5>
                                             <ul class="mega-menu-item">
                                                <li><a class="dropdown-item" href="shop-grid.html">Storage</a></li>
                                                <li><a class="dropdown-item" href="shop-grid.html">Lighting</a></li>
                                                <li><a class="dropdown-item" href="shop-grid.html">Sofa</a></li>
                                                <li><a class="dropdown-item" href="shop-grid.html">Chair</a></li>
                                                <li><a class="dropdown-item" href="shop-grid.html">Armchair</a></li>
                                                <li><a class="dropdown-item" href="shop-grid.html">Table</a></li>
                                             </ul>
                                          </div>
                                          <div class="col-12 col-lg-2">
                                             <h5 class="mega-menu-title">Furniture</h5>
                                          ...
                                          <div class="col-12 col-lg-4">
                                             <div class="mega-menu-img">
                                                <a href="#"><img src="{{ asset('images/banner/mega-menu-banner.jpg') }}"></a>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                        ...
                        <div class="nav-right">
                           <ul class="nav-right-list">
                              ...
                              <li>
                                 <a href="wishlist.html" class="list-link">
                                    ...
                                    <ul class="dropdown-cart-list">
                                       <li>
                                          <div class="dropdown-cart-item">
                                             <div class="cart-img">
                                                <a href="#"><img src="{{ asset('images/product/06.png') }}"></a>
                                             </div>
                                             <div class="cart-info">
                                                <h4><a href="#">Living Room Chair</a></h4>
                                       ...
                                       <li>
                                          <div class="dropdown-cart-item">
                                             <div class="cart-img">
                                                <a href="#"><img src="{{ asset('images/product/14.png') }}"></a>
                                             </div>
                                             <div class="cart-info">
                                                <h4><a href="#">Living Room Chair</a></h4>
                                       ...
                                       <li>
                                          <div class="dropdown-cart-item">
                                             <div class="cart-img">
                                                <a href="#"><img src="{{ asset('images/product/15.png') }}"></a>
                                             </div>
                                             <div class="cart-info">
                                                <h4><a href="#">Living Room Chair</a></h4>
