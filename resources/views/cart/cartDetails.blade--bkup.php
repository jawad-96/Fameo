...
{{--                                {{dd($cart->courierAssignment,$product->courier_detail->couriers_id)}}--}}
                            ...
                            @if(Auth::user()->type == 'dropshipper' && ($count ==1 && $product->quantity == 1) )
                ...
                <div class="btn-cart-totals">
                    ...
                    @if($count > 0)
                        ...
                        @if(Auth::user()->type != 'dropshipper' || ($count ==1 && $product->quantity == 1) )
                            ...
                            <a href="{{url('make-payment')}}" class="checkout" title="">Proceed to Checkout</a>
                        @elseif($cart->courierAssignment == 'null' || @$cart->courierAssignment->status == 0 )
                            <a href="{{url('products')}}" class="update" title="">Continue Shopping</a>
                            <a href="{{url('proceed-admin-request')}}" class="checkout" title="">Request to Admin</a>
