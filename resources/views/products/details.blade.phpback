                        ...
                        <div class="footer-detail">
                            ...
                            <div class="box-cart style2">
                                <div class="btn-add-cart">
                                    <a href="javascript:void(0)" title="" data-id="{{$product->id}}" class="add-to-cart"   <?php if($product->store_products[0]->quantity > 0) {echo '';} else {echo 'disabled=disabled';}?>><img src="{{asset('front_assets/images/icons/add-cart.png')}}" alt="">{{(isset($product->store_products) and $product->store_products->count() >0 and $product->store_products[0]->quantity>0)?'Add to Cart':'Out of stock'}}</a>
                                </div>
