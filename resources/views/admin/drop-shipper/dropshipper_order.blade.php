                    ...
                    <section class="panel">
                        <header class="panel-heading">Customers
                            <span class="tools pull-right">
                                <a href="{{url('admin/update-status/dropshipper')}}" class="btn btn-info btn-sm" data-toggle="tooltip" title="" data-original-title="Add New Admin">
    ...
    <script>
        ...
        $("document").ready(function () {
            $('#datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.shipper.orders') }}",
                    data : function(d){
