...
@section('scripts')
    <script type="text/javascript">
        ...
        $("body").on("click",'.adjustOverdueAmount',function () {
            if (confirm(`Are you sure to adjust overdue amount?`)) {
                window.location.href = '{{ url("admin/adjust-overdue-amount") }}' + '/' + $(this).data('id');
                return false;
            }
